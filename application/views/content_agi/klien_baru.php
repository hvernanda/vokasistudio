        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Form New Client</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="<?php echo site_url('klien_baru/tambah')?>" enctype="multipart/form-data" id="formTambahKlien">
              <div class="box-body">
              ...
              <?php echo $this->session->flashdata('msgtrue');?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea class="form-control" id="inputAlamat" rows="3" placeholder="alamat" name="alamat"></textarea>
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
